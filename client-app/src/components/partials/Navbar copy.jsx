...
import { 
  ...
  useColorModeValue, useBreakpointValue, useDisclosure, Avatar, Menu, MenuButton, MenuList, MenuItem, MenuDivider, Center, 
  useColorMode 
...
export default function Navbar({ isLoggedIn, username }) {
  ...
  const { colorMode, toggleColorMode } = useColorMode(); // Agregado para cambiar el modo de color
          ...
          {isLoggedIn ? (
            <Menu>
              ...
              <MenuList alignItems={'center'}>
                ...
                <MenuItem>Configuración de la cuenta</MenuItem>
